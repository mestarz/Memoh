...
export const itemVariants = cva(
  'group/item flex items-center border border-transparent text-xs rounded-lg transition-colors [a]:hover:bg-accent/50 [a]:transition-colors duration-100 flex-wrap outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] shadow-none',
  {
    variants: {
      variant: {
