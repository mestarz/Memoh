...
export const getAppSettingsNetworkQueryKey = (options?: Options<GetAppSettingsNetworkData>) => createQueryKey('getAppSettingsNetwork', options);

/**
 * Get network/proxy settings
 *
 * Returns the global HTTP proxy URL applied to providers that opted in.
 */
export const getAppSettingsNetworkQuery = defineQueryOptions((options?: Options<GetAppSettingsNetworkData>) => ({
    key: getAppSettingsNetworkQueryKey(options),
    query: async (context) => {
        const { data } = await getAppSettingsNetwork({
            ...options,
            ...context,
            throwOnError: true
        });
 ...
 *
 * Sets the global HTTP proxy URL. An empty value clears the proxy.
 */
export const putAppSettingsNetworkMutation = (options?: Partial<Options<PutAppSettingsNetworkData>>): UseMutationOptions<PutAppSettingsNetworkResponse, Options<PutAppSettingsNetworkData>, PutAppSettingsNetworkError> => ({
    mutation: async (vars) => {
        const { data } = await putAppSettingsNetwork({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Test the configured (or supplied) HTTP proxy
 *
 * Issues an HTTP GET against target_url through the proxy and reports outcome.
 */
export const postAppSettingsNetworkTestMutation = (options?: Partial<Options<PostAppSettingsNetworkTestData>>): UseMutationOptions<PostAppSettingsNetworkTestResponse, Options<PostAppSettingsNetworkTestData>, PostAppSettingsNetworkTestError> => ({
    mutation: async (vars) => {
        const { data } = await postAppSettingsNetworkTest({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 *
 * Upload a JPEG/PNG/GIF/WebP image as an avatar; returns its serving URL.
 */
export const postAvatarsUploadMutation = (options?: Partial<Options<PostAvatarsUploadData>>): UseMutationOptions<PostAvatarsUploadResponse, Options<PostAvatarsUploadData>, Error> => ({
    mutation: async (vars) => {
        const { data } = await postAvatarsUpload({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Render speech for a bot and return audio directly
 *
 * Synthesize text using the bot's configured TTS model and return raw audio bytes
 */
export const postBotsByBotIdTtsRenderMutation = (options?: Partial<Options<PostBotsByBotIdTtsRenderData>>): UseMutationOptions<unknown, Options<PostBotsByBotIdTtsRenderData>, PostBotsByBotIdTtsRenderError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdTtsRender({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getSearchProvidersByIdProbeKeysQueryKey = (options: Options<GetSearchProvidersByIdProbeKeysData>) => createQueryKey('getSearchProvidersByIdProbeKeys', options);

/**
 * Probe Tavily API key usage
 *
 * Query usage stats for all Tavily API keys in a provider's pool. Only supported for Tavily providers.
 */
export const getSearchProvidersByIdProbeKeysQuery = defineQueryOptions((options: Options<GetSearchProvidersByIdProbeKeysData>) => ({
    key: getSearchProvidersByIdProbeKeysQueryKey(options),
    query: async (context) => {
        const { data } = await getSearchProvidersByIdProbeKeys({
            ...options,
            ...context,
            throwOnError: true
        });
