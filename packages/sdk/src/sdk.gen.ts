 ...
 */
export const getAppSettingsNetwork = <ThrowOnError extends boolean = false>(options?: Options<GetAppSettingsNetworkData, ThrowOnError>) => (options?.client ?? client).get<GetAppSettingsNetworkResponses, GetAppSettingsNetworkErrors, ThrowOnError>({ url: '/app-settings/network', ...options });
 ...
 */
export const putAppSettingsNetwork = <ThrowOnError extends boolean = false>(options: Options<PutAppSettingsNetworkData, ThrowOnError>) => (options.client ?? client).put<PutAppSettingsNetworkResponses, PutAppSettingsNetworkErrors, ThrowOnError>({
 ...
 */
export const postAppSettingsNetworkTest = <ThrowOnError extends boolean = false>(options: Options<PostAppSettingsNetworkTestData, ThrowOnError>) => (options.client ?? client).post<PostAppSettingsNetworkTestResponses, PostAppSettingsNetworkTestErrors, ThrowOnError>({
 ...
 */
export const postAvatarsUpload = <ThrowOnError extends boolean = false>(options: Options<PostAvatarsUploadData, ThrowOnError>) => (options.client ?? client).post<PostAvatarsUploadResponses, unknown, ThrowOnError>({
 ...
 */
export const postBotsByBotIdTtsRender = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdTtsRenderData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdTtsRenderResponses, PostBotsByBotIdTtsRenderErrors, ThrowOnError>({
 ...
 */
export const getSearchProvidersByIdProbeKeys = <ThrowOnError extends boolean = false>(options: Options<GetSearchProvidersByIdProbeKeysData, ThrowOnError>) => (options.client ?? client).get<GetSearchProvidersByIdProbeKeysResponses, GetSearchProvidersByIdProbeKeysErrors, ThrowOnError>({ url: '/search-providers/{id}/probe-keys', ...options });
