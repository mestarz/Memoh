...
WITH updated AS (
  ...
  SET language = $1,
      ...
      chat_model_id = $11::uuid,
      heartbeat_model_id = $12::uuid,
      compaction_model_id = $13::uuid,
      title_model_id = $14::uuid,
      search_provider_id = $15::uuid,
      memory_provider_id = $16::uuid,
      image_model_id = $17::uuid,
      tts_model_id = $18::uuid,
      transcription_model_id = $19::uuid,
