...
SET language = sqlc.arg(language),
    ...
    chat_model_id = sqlc.narg(chat_model_id),
    heartbeat_model_id = sqlc.narg(heartbeat_model_id),
    compaction_model_id = sqlc.narg(compaction_model_id),
    title_model_id = sqlc.narg(title_model_id),
    search_provider_id = sqlc.narg(search_provider_id),
    memory_provider_id = sqlc.narg(memory_provider_id),
    image_model_id = sqlc.narg(image_model_id),
    tts_model_id = sqlc.narg(tts_model_id),
    transcription_model_id = sqlc.narg(transcription_model_id),
