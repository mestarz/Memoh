...
WITH updated AS (
  ...
  SET language = sqlc.arg(language),
      ...
      chat_model_id = sqlc.narg(chat_model_id)::uuid,
      heartbeat_model_id = sqlc.narg(heartbeat_model_id)::uuid,
      compaction_model_id = sqlc.narg(compaction_model_id)::uuid,
      title_model_id = sqlc.narg(title_model_id)::uuid,
      search_provider_id = sqlc.narg(search_provider_id)::uuid,
      memory_provider_id = sqlc.narg(memory_provider_id)::uuid,
      image_model_id = sqlc.narg(image_model_id)::uuid,
      tts_model_id = sqlc.narg(tts_model_id)::uuid,
      transcription_model_id = sqlc.narg(transcription_model_id)::uuid,
