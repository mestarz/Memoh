...
const docTemplate = `{
    ...
    "paths": {
        "/app-settings/network": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.AppNetworkSettings"
                        }
                    },
                    "500": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Network settings payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/app-settings/network/test": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Proxy test payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.AppNetworkTestRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.AppNetworkTestResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.avatarUploadResponse"
                        }
                    }
                }
            }
        ...
        "/search-providers/{id}/probe-keys": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/websearch.TavilyKeyUsage"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "handlers.AppNetworkTestRequest": {
            "type": "object",
            "properties": {
                "http_proxy_url": {
                    "type": "string"
        ...
        "handlers.AppNetworkTestResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string"
